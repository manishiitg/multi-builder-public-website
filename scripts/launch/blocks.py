    ...
    return f'''<div class="tiers">
          ...
          <article class="tier tier-featured reveal">
            ...
            <ul class="tier-list">
              ...
              <li>Personal onboarding: your first goal set up with you</li>
...
FAQ_HOME=[
 ...
 ("Which AI plans can I use?","Claude (Pro or Max), ChatGPT (Plus or Pro), Gemini and Cursor, through Claude Code, Codex, Cursor, Pi and Muse. You can also add API keys from OpenAI, Anthropic, Google, AWS Bedrock, Azure or OpenRouter."),
